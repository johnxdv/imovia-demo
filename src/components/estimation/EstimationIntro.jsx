  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <div className="relative rounded-2xl border border-ink/10 bg-white p-8 shadow-[0_22px_54px_-16px_rgba(16,20,28,0.3),0_0_38px_-6px_rgba(176,141,87,0.5)] sm:p-9">
        ...
        <p className="mx-auto mt-4 max-w-sm text-center font-display text-[1.02rem] leading-relaxed text-ink/60">
        ...
        <div className="relative mt-8 animate-cta-pop">
          ...
          >
            ...
            <span className="relative inline-flex items-center gap-2.5 font-display text-[0.95rem] font-semibold uppercase tracking-[0.07em] text-white">
